<!--
	...
	- Add brighter server title

    v.1.1
    - Enhance file counting (still not 100% accurate);
    - Add "server name";
    ...
    - UpdateText(): add support to control the number of messages to display + enhance gradient effect;
...
<html>
    ...
    <body style='overflow: hidden; background-color: #FFFFFF;'>
        ...
        <script type="text/javascript">
            ...
            {
				var title = document.getElementById("infos");

                title.innerHTML = servername;
				title.style.color = '#001133';
				title.style.textShadow = "1px 2px 2px #d6e0f5";
